...
taskkill /f /fi "WINDOWTITLE eq Python Rust Helper*" > nul 2>&1
...
:: Start the Python Rust helper in another window
start cmd /c "title Python Rust Helper && python rust_helper.py"
